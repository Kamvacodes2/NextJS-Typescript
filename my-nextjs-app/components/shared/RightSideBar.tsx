...
const RightSideBar = () => {
  const hotQuestions = [
    {
      _id: 1,
      title: "Github contribution remaining stagnant",
    },
    {
      _id: 2,
      title: "How to use Select for Compare in VSCode",
    },
    {
      _id: 3,
    ...
    {
      _id: 4,
      titlel: "Github contribution remaining stagnant",
    },
  ];

  const popularTags = [
    { _id:1, name: 'Javascript', totalQuestions: 5 },
    { _id:1, name: 'Nodejs', totalQuestions: 2 },
    { _id:1, name: 'MERN', totalQuestions: 2 },
